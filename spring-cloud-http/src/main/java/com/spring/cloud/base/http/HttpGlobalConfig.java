...
import static com.spring.cloud.base.utils.base.ReflectUtil.getFieldValue;
...
public class HttpGlobalConfig implements Serializable {
    ...
    private static String boundary = "--------------------SpringCloud_" + RandomUtil.randomString(16);
    ...
    synchronized public static void allowPatch() {
        ...
        // 检查注入是否成功
        final Object staticFieldValue = getStaticFieldValue(methodsField);
