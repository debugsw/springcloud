...
public enum CurrencyEnum {
     ...
     * 波兰兹罗提 [PLN]
     */
    PLN("PLN", "985", new String(new char[]{0x50, 0x4c, 0x4e})),
     ...
     * 智利比索 [$]
     */
    CLP("CLP", "152", new String(new char[]{0x24})),
     ...
     * 肯尼亚先令 [KES]
     */
    KES("KES", "404", new String(new char[]{0x4b, 0x45, 0x53})),
     ...
     * 新西兰元 [$]
     */
    NZD("NZD", "554", new String(new char[]{0x24})),
     ...
     * 瑞典克朗 [kr]
     */
    SEK("SEK", "752", new String(new char[]{0x6b, 0x72})),
